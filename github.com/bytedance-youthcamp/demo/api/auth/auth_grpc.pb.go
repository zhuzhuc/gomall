...
const (
	...
	AuthService_RenewTokenByRPC_FullMethodName  = "/auth.AuthService/RenewTokenByRPC"
)
...
type AuthServiceClient interface {
	...
	RenewTokenByRPC(ctx context.Context, in *RenewTokenReq, opts ...grpc.CallOption) (*RenewTokenResp, error)
}
...
func (c *authServiceClient) RenewTokenByRPC(ctx context.Context, in *RenewTokenReq, opts ...grpc.CallOption) (*RenewTokenResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RenewTokenResp)
	err := c.cc.Invoke(ctx, AuthService_RenewTokenByRPC_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	RenewTokenByRPC(context.Context, *RenewTokenReq) (*RenewTokenResp, error)
...
func (UnimplementedAuthServiceServer) RenewTokenByRPC(context.Context, *RenewTokenReq) (*RenewTokenResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RenewTokenByRPC not implemented")
}
...
func _AuthService_RenewTokenByRPC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RenewTokenReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).RenewTokenByRPC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_RenewTokenByRPC_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).RenewTokenByRPC(ctx, req.(*RenewTokenReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RenewTokenByRPC",
			Handler:    _AuthService_RenewTokenByRPC_Handler,
		},
	},
